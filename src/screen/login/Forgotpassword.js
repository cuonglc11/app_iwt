            ...
            <SafeAreaView style={{ flex: 1, padding: 10 }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                        <TouchableOpacity style={{ width: 70, marginStart: 10, height: 60, alignItems: 'center', justifyContent: 'center', backgroundColor: "#8C8D8E", marginTop: 6, borderRadius: 20 }}>
                ...
                <View style={{ flex: 1, flexDirection: 'row' , marginTop : 40  }}>
                    <TouchableOpacity style={{ marginStart: 5, marginVertical: 10, backgroundColor: app_color, flex: 1 , height : 50, justifyContent: 'center', alignItems: 'center', borderRadius: 20 }}>
