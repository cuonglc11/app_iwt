    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <ScrollView>
                ...
                <Text style={{ color: ' #8C8D8E', margin: 5 }}>Mã CV : 11111111111111111</Text>
                <Text style={{ color: ' #8C8D8E', margin: 5 }}>Nhân viên kỹ thuật : KT - Lù Mạnh Cường</Text>
                ...
                <View style={{ marginStart: 5, marginEnd: 5 }}>
                    <CustomTextInput placeholder={"Nhập thông tin ví trí"}  />
                </View>
                <Text style={{ color: 'black', fontSize: 18, margin: 10, fontWeight: 'bold' }}>
                    Tải ảnh chứng từ 
                </Text>
                ...
                >
                    <Text style={{ color: app_color, fontSize: 18, fontWeight: 'bold' }}> Vật tư</Text>
                </TouchableOpacity>
            </ScrollView>
        </SafeAreaView>
    )
