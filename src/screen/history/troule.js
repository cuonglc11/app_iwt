...
const TroubleHostoryScreen = ({ navigation }) => {
    ...
    const renItem = ({ item }) => {
        return (
            <View style={{ width: '90%', backgroundColor: "#fff", borderBottomColor: "rgba(0, 0, 0, 0.1)", borderBottomWidth: 2, flexDirection: "row", marginTop: 20,alignSelf :'center', height: 120, borderRadius: 40 }}>
                <Image
